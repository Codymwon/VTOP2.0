      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-1.5 custom-scrollbar">
        ...
        <div>
          <button
            ...
            className={`w-full flex items-center gap-2.5 px-2.5 py-2 min-h-[40px] rounded-xl text-xs font-bold transition-all cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#176CB8] ${
            ...
            return (
              <div key={cat.id} className="space-y-0.5">
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-2 py-1.5 min-h-[38px] text-left rounded-lg transition-all cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#176CB8] ${
                    hasActiveChild
                ...
                >
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    {cat.badge && (
                      <span className="text-[9px] font-bold text-slate-500 bg-slate-100 px-1 py-0.5 rounded border border-slate-200/60 tabular-nums">
                        {cat.badge}
                      </span>
                    )}
                    <ChevronDown
                      className={`w-3 h-3 transition-transform duration-200 ${
                        isExpanded ? 'rotate-0 text-slate-700' : '-rotate-90 text-slate-400'
                      }`}
                      aria-hidden="true"
                    />
                  </div>
                    ...
                    {cat.items.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-center justify-between px-2.5 py-1.5 min-h-[36px] rounded-lg text-[11px] transition-colors cursor-pointer text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-[#176CB8] ${
                            isItemActive
                          ...
                          <div className="flex items-center gap-2 min-w-0">
                            <SubIcon
                              className={`w-3.5 h-3.5 shrink-0 ${
                                isItemActive ? 'text-[#176CB8]' : 'text-slate-400'
                              }`}
                              aria-hidden="true"
                            />
      ...
      <div className="p-2.5 px-3 border-t border-slate-100 bg-slate-50/70 shrink-0">
        <div className="flex items-center justify-between text-[10px] text-slate-500">
          <a
            ...
            className="flex items-center gap-1.5 hover:text-[#176CB8] transition-colors focus:outline-none focus-visible:underline"
            title="IT Helpdesk Hotline"
          >
            <LifeBuoy className="w-3 h-3 text-[#176CB8]" aria-hidden="true" />
            <span>Helpdesk: Ext. 1040</span>
          </a>
          <span className="font-semibold text-slate-400">VIT-AP</span>
        </div>
      </div>
    </div>
  );
            ...
            <div className="bg-gradient-to-r from-[#183668] via-[#2455A3] to-[#183668] text-white px-3.5 py-3 flex items-center justify-between shrink-0 shadow-xs">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0 border-l border-white/20 pl-2">
                  ...
                  <div className="text-[9px] text-blue-200 truncate">Navigation</div>
                </div>
              </div>
              ...
              <button
                ...
                className="w-9 h-9 min-w-[36px] min-h-[36px] rounded-lg bg-white/10 hover:bg-white/20 active:bg-white/30 text-white flex items-center justify-center transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white cursor-pointer"
              >
            ...
            <div className="px-3 py-2 border-b border-slate-100 flex items-center justify-between bg-slate-50/70 shrink-0">
              ...
              {onToggle && (
                <button
                  ...
                  className="w-7 h-7 min-w-[28px] min-h-[28px] rounded-lg text-slate-400 hover:text-slate-800 hover:bg-slate-200/70 flex items-center justify-center transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#176CB8] cursor-pointer"
                >
